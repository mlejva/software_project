...
from network_modif_2 import Network

import video_preprocessor_modif_2 as video_prep
...
if __name__ == "__main__":
    ...
    for i in range(epochs):        
        ...
        while i == vp.epochs_completed:            
            input_frames, gold_output_frames = vp.next_batch(grayscale=False)            

            video_prep.save_gold_output_frames("./color-%d.png" % j, gold_output_frames, grayscale=False)                        
        ...
        input_frames_val, gold_output_frames_val = vp.validation_dataset(grayscale=False)        
        ...
        input_frames_test, gold_output_frames_test = vp.testing_dataset(grayscale=False)    
